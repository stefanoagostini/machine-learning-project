...
LAttn = model.LAttOnly(input_size)
...
optimizer = torch.optim.Adam(LAttn.parameters(), lr=learning_rate)
...
for epoch in range(num_epochs):
    ...
    if min_valid_loss > val_loss:
        ...
        # Saving State Dict
        torch.save(LAttn.state_dict(),
                   f'src/models/model_epoch_lattn_ {str(epoch)}.pth')
