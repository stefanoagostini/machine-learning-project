...
GAttn = model.GAttOnly(input_size)
...
optimizer = torch.optim.Adam(GAttn.parameters(), lr=learning_rate)
...
for epoch in range(num_epochs):
    ...
    if min_valid_loss > val_loss:
        ...
        # Saving State Dict
        torch.save(GAttn.state_dict(),
                   f'src/models/model_epoch_GAttn_ {str(epoch)}.pth')
